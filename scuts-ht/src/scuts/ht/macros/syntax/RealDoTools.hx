...
class RealDoTools {
  ...
  public static function buildWithMonad <M>(monad:ExprOf<scuts.ht.classes.Monad<M>>, exprs:Array<Expr>, isUpcasted:Bool, isMonadZero:Bool, ?monadId:Expr)
  {
    ...
    var monadExpr = if (isConstIdent) monad else macro @:pos(Context.currentPos()) ___monad;
    ...
    var res = if (isConstIdent) generated else macro @:pos(Context.currentPos()) { var ___monad = $monad; $generated; }
