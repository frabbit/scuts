...
interface Foldable<F>
{
   ...
   */
  public function fold <A>(x:F<A>, mon:Monoid<A>):A;
   ...
   */
  public function foldMap <A,B>(x:F<A>, f:A->B, mon:Monoid<B> ):B;
   ...
   */
  public function foldLeft <A,B>(x:F<B>, init:A, f:A->B->A):A;
   ...
   */
  public function foldRight <A,B>(x:F<A>, init:B, f:A->B->B):B;
   ...
   *
   */
  public function foldLeft1 <A>(x:F<A>, f:A->A->A):A;
   ...
   */
  public function foldRight1 <A>(x:F<A>, f:A->A->A):A;
