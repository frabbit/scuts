...
class FailProjectionExt
{
  ...
  @:noUsing
  public static function fromOption<F,S>(o:Option<S>, f:Void->F):VD<F,S> return switch (o)
  {
  ...
  @:noUsing
  public static function fromOptionC<F,S>(o:Option<S>, f:F):VD<F,S> return switch (o)
  {
    case Some(s): Success(s);
    case None:    Failure(f);
  }
