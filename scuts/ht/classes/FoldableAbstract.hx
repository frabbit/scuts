...
import scuts.ht.instances.DualInstances.monoid in dualMonoid;
import scuts.ht.instances.DualInstances.semigroup in dualSemigroup;
import scuts.ht.instances.EndoInstances.monoid in endoMonoid;
