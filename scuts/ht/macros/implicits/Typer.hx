...
class Typer {
  ...
  public static function typeof1(x:Expr):Option<Type>
  {
  ...
  {
    return @:pos(x.pos) Profiler.profile(function ()
    {
  ...
  public static function isCompatible (e:Expr, to:Expr)
  {
    return Profiler.profile(function ()
    {
      ...
      var test = macro $helper.typeAsParam($to)($e);
      var res =  Typer.typeof(test).isSome();
