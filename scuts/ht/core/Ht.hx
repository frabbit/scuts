...
class Ht
{
  ...
  @:noUsing
  macro public static function implicit2 (e:Array<Expr>):Expr
  {
  ...
  @:noUsing
  #if !macro macro #end
  public static function preservedCast (e:Expr):Expr
  {
    return macro (inline function () return $e)();
  }
  @:noUsing
  #if !macro macro #end
  public static function checkType (e:Expr):Expr
  {
  ...
  @:noUsing
  #if !macro macro #end
  public static function preservedCheckType (e:Expr):Expr
  {
    return switch (e.expr) {
  ...
  @:noUsing
  macro public static function implicitly (e:Expr):Expr
  {
    var s = switch (e.expr) {
   ...
   */
  #if !macro macro #end
  public static function _ (f:Expr, ?args:Array<Expr>):Expr
  {
  ...
  @:noUsing
  #if !macro macro #end
  public static function resolve (f:Expr, ?args:Array<Expr>):Expr
  {
    return Resolver.resolve(f, args);
  }
  ...
  @:noUsing
  #if !macro macro #end
  public static function resolveIfTypeable (f:Expr, ?args:Array<Expr>):Expr
  {
    return try {
      switch (f) {
        case macro trace, { expr : EConst(CIdent("$type"))}, macro scuts.ht.core.Ht.resolve, macro scuts.ht.core.Ht.resolveIfTypeable: throw "false";
        case _:
      }
      Context.typeof(f);
      Resolver.resolve(f, args);
    } catch (e:Dynamic) {
