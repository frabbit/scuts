...
class Tup3MonoidImpl<A,B,C> extends MonoidAbstract<Tup3<A,B,C>>
{
...
typedef Tup3Monoid = haxe.macro.MacroType<[hots.macros.TypeClasses.createProvider(Tup3MonoidImpl)]>;