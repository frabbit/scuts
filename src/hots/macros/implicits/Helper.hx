...
class Helper 
{
  ...
  public static inline function toImplicitObject  <A>            (a:A)                  :hots.ImplicitObject<A> return null
  public static inline function toImplicitObject0 <A>            (a:Void->A)            :Void->hots.ImplicitObject<A> return null
  public static inline function toImplicitObject1 <A,B>          (a:A->B)               :A->hots.ImplicitObject<B> return null
  public static inline function toImplicitObject2 <A,B,C>        (a:A->B->C)            :A->B->hots.ImplicitObject<C> return null
  public static inline function toImplicitObject3 <A,B,C,D>      (a:A->B->C->D)         :A->B->C->hots.ImplicitObject<D> return null
  public static inline function toImplicitObject4 <A,B,C,D,E>    (a:A->B->C->D->E)      :A->B->C->D->hots.ImplicitObject<E> return null
  public static inline function toImplicitObject5 <A,B,C,D,E,F>  (a:A->B->C->D->E->F)   :A->B->C->D->E->hots.ImplicitObject<F> return null
  public static inline function toImplicitObject6 <A,B,C,D,E,F,G>(a:A->B->C->D->E->F->G):A->B->C->D->E->F->hots.ImplicitObject<G> return null
