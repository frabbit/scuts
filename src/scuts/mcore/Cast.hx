...
class Cast 
{
  ...
  public static function unsafeCast (expr:Expr, type:ComplexType, ?pos:Position):Expr
  {
  ...
  public static function unsafeCastForType (expr:Expr, fromType:Type, toType:Type, wildcards:Array<Type>, ?pos:Position):Expr
  {
