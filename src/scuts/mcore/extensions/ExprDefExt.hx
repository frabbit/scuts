...
class ExprDefExt 
{
  ...
  public static function eq (a:ExprDef, b:ExprDef):Bool 
  {
    ...
    return switch (a) {
      ...
      case EBinop(op1, e1a, e2a):            switch (b) { case EBinop(op2, e1b, e2b):            BinopExt.eq(op1, op2) && eeq(e1a, e1b) && eeq(e2a, e2b); default: false; };
      ...
      case EUnop(op1, postFix1, e1):         switch (b) { case EUnop(op2, postFix2, e2):         UnopExt.eq(op1, op2) && eqBool(postFix1,postFix2) && eeq(e1, e2);     default: false; };
