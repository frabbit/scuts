...
class Functions 
{
  ...
  public static function returns (f:Function, ret:ComplexType):Function
  {
    return {
      args: f.args,
      ret: ret,
  ...
  public static function body (f:Function, expr:Expr):Function
  {
    return {
      args: f.args,
      ret: f.ret,
  ...
  public static function addParam (f:Function, name:String, constraints:Array<ComplexType>):Function
  {
    return {
      args: f.args,
      ret: f.ret,
