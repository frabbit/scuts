...
class Check 
{
  public static function isConstantTypeDecl (t:ComplexType):Bool
  {
    return switch (t) {
      case TPath(p):
  ...
  public static function isConstantExpr (expr:Expr):Bool
  {
    return switch (expr.expr) {
      ...
      case EConst(c):
        switch (c) {
          case CInt(_), CString(_), CFloat(_): 
            true;
          default:
            false;
        }
  ...
  public static function isEmptyBlock (expr:Expr) {
    return 
      switch (expr.expr) {
        case EBlock(exprs):
          exprs.length == 0;
  ...
  public static function isBlockAndLastExprIsVoidReturn (e:Expr):Bool {
        ...
        if (exprs.length > 0) {
          ...
          switch (lastExpr.expr) {
            case EReturn(eret):
              ...
              eret == null;
            case EBlock(block):
              isBlockAndLastExprIsVoidReturn(lastExpr);
            default:
              false;
          }
        }
  ...
  public static function isVoidFunction (f:Function) {
    var hasReturnVoidType = f.ret != null && switch (f.ret) {
      case TPath(p):
        p.name == "Void" && p.pack.length == 0;
      default:
        false;
    };
  ...
  public static function isConst (e:Expr) {
    return switch (e.expr) {
      case EConst(_): true;
      default: false;
    }
  ...
  //EConst
  public static function isEConst (e:Expr):Bool {
    return switch (e.expr) {
      case EConst(_):
        true;
      default:
  ...
  // EBlock
  public static function isEBlock (e:Expr):Bool {
    return switch (e.expr) {
      case EBlock(c):
        true;
      default:
  ...
  public static function isEArray (e:Expr):Bool {
    return switch (e.expr) {
  ...
  public static function isEBinop (e:Expr):Bool {
  ...
  public static function isEBinopWithOpFilter (e:Expr, opFilter:Binop->Bool):Bool {
    
    return switch (e.expr) {
      case EBinop(op,_,_): 
        opFilter == null || opFilter(op);
      default: false;
    }
  }
  ...
  public static function isEBinopAssign (e:Expr):Bool {
    ...
    return isEBinopWithOpFilter(e, function (op) {
      return switch (op) {
  ...
  public static function isEField (e:Expr):Bool {
    return switch (e.expr) {
  ...
  public static function isEType (e:Expr, ?fieldFilter:String->Bool):Bool {
    var fieldFilter = fieldFilter.getOrElse(function (_) return true);
    return switch (e.expr) {
  ...
  // EParenthesis( e : Expr );
  public static function isEParenthesis (e:Expr):Bool {
    return switch (e.expr) {
      case EParenthesis(e):
        true;
      default:
  ...
  public static function isEObjectDecl (e:Expr):Bool {
    return switch (e.expr) {
      case EType(_):  true;
      default:        false;
    }
  ...
  public static function isEArrayDecl (e:Expr):Bool {
    return switch (e.expr) {
      case EArrayDecl(_): true;
      default:            false;
    }
  ...
  public static function isECall (e:Expr):Bool {
    return switch (e.expr) {
      case ECall(_,_): true;
      default: false;
    }
  ...
  public static function isEUnop (e:Expr, ?unopFilter:Unop -> Bool):Bool {
    unopFilter = unopFilter.getOrElse(function (_) return true);
  ...
  public static function isEVars (e:Expr):Bool {
    return switch (e.expr) {
      case EVars(_): true;
      default: false;
    }
  ...
  public static function isEFunction (e:Expr):Bool {
    return switch (e.expr) {
  ...
  public static function isEFor (e:Expr):Bool {
    return switch (e.expr) {
      case EFor(_,_): true;
      default: false;
    }
	...
	//EIn( e1 : Expr, e2 : Expr );
  public static function isEIn (e:Expr):Bool {
    return switch (e.expr) {
      case EIn(_,_):  true;
      default:        false;
    }
  ...
  public static function isEIf (e:Expr):Bool {
    return switch (e.expr) {
      case EIf(_,_, _):   true;
      default:            false;
    }
  ...
  public static function isEWhile (e:Expr):Bool {
    return switch (e.expr) {
  ...
  public static function isESwitch (e:Expr):Bool {
    return switch (e.expr) {
  ...
  public static function isETry (e:Expr):Bool {
    return switch (e.expr) {
      case ETry(_): true;
      default: false;
    }
	...
	//EReturn( ?e : Null<Expr> );
  public static function isEReturn (e:Expr):Bool {
    return switch (e.expr) {
      case EReturn(_): true;
      default: false;
    }
	...
	//EBreak;
  public static function isEBreak (e:Expr):Bool {
    return switch (e.expr) {
      case EBreak: true;
      default: false;
    }
  ...
  public static function isEContinue (e:Expr):Bool {
    return switch (e.expr) {
      case EContinue: true;
      default: false;
    }
	...
	//EUntyped( e : Expr );
  public static function isEUntyped (e:Expr):Bool {
    return switch (e.expr) {
	...
	//EThrow( e : Expr );
  public static function isEThrow (e:Expr):Bool {
    return switch (e.expr) {
      case EThrow(_): true;
      default: false;
    }
  ...
  public static function isECast (e:Expr):Bool {
    return switch (e.expr) {
      case ECast(_,_): true;
      default: false;
    }
  ...
  public static function isEDisplay (e:Expr):Bool {
    return switch (e.expr) {
  ...
  public static function isEDisplayNew (e:Expr):Bool {
    return switch (e.expr) {
  ...
  public static function isETernary (e:Expr):Bool {
    return switch (e.expr) {
  ...
  // Constant Checks
  public static function isCFloat (c:Constant):Bool {
    return switch (c) {
      case CFloat(_): true;
      default: false;
    }
  ...
  public static function isCInt (c:Constant):Bool {
    return switch (c) {
      case CInt(_): true;
      default: false;
    }
  ...
  public static function isCString (c:Constant):Bool {
    return switch (c) {
      case CString(_): true;
      default: false;
    }
  ...
  public static function isCRegexp (c:Constant):Bool {
    return switch (c) {
  ...
  public static function isCType (c:Constant):Bool {
    return switch (c) {
      case CType(_): true;
      default: false;
    }
  ...
  public static function isCIdent (c:Constant):Bool {
    return switch (c) {
      case CIdent(_): true;
      default: false;
    }
