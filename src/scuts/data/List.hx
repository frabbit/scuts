...
class ListExt {
  ...
  public static function isEmpty <T> (l:List<T>):Bool 
  {
    return switch (l) { case Nil:true; default: false;}
  }
  ...
  public static function toString <T> (list:List<T>, s:Show<T>):String {
