...
import scuts1.macros.implicits.Tools;

import scuts.core.Tuples;
import scuts.mcore.Make;
import scuts.mcore.Print;
import scuts1.macros.syntax.DoData;
import scuts.Scuts;
...
class DoTools {
  ...
  static var helper(default, null) = macro scuts1.macros.syntax.DoHelper;
  ...
  public static function buildWithMonad <M>(monad:ExprOf<scuts1.classes.Monad<M>>, exprs:Array<Expr>, isUpcasted:Bool, isMonadZero:Bool) 
  {
    ...
    var generated = ast.map(toExpr.bind(_, monad)).getOrElse(handleErr);
