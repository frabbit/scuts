...
import scuts1.macros.implicits.Data;
...
class Tools 
{
  ...
  public static function prettyExpr (x:Expr) 
  {
    ...
    return first.split("scuts1.macros.Implicits.ImplicitsHelper.").join("_").split("scuts1.syntax.").join("scuts1.ext.");
  }
  ...
  public static function prettyType (t:Type) 
  {
    ...
    var pretty = first
      .split("scuts1.core.Of").join("Of")
      .split("scuts1.core.In").join("In")
      .split("StdTypes.").join("")
